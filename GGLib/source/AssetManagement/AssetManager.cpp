...
void GG::AssetManager::init(SDL_Renderer* newRenderer, MIX_Mixer* mixer)
{
	renderer = newRenderer;
}

void GG::AssetManager::setBaseAssetPath(std::string newBaseAssetPath)
{
	baseAssetPath = newBaseAssetPath;
}

bool GG::AssetManager::loadFont(std::string fileName, int fontSize)
{
...
std::optional<TTF_Font*> GG::AssetManager::getFont(std::string fileName) const
{
	if (!fontPtrs->contains(fileName)) return std::nullopt;
	return fontPtrs->at(fileName);
}
void GG::AssetManager::unloadFont(std::string fileName)
{
...
std::weak_ptr<std::unordered_map<std::string, TTF_Font*>> GG::AssetManager::getFontPtrs() const
{
	return fontPtrs;
}


bool GG::AssetManager::loadAudio(std::string fileName)
{
...
std::optional<MIX_Audio*> GG::AssetManager::getAudio(std::string fileName) const
{
	if (!audioPtrs->contains(fileName)) return std::nullopt;
	return audioPtrs->at(fileName);
}
void GG::AssetManager::unloadAudio(std::string fileName)
{
...
std::weak_ptr<std::unordered_map<std::string, MIX_Audio*>> GG::AssetManager::getAudioPtrs() const
{
	return audioPtrs;
}


bool GG::AssetManager::loadTexture(std::string fileName)
{
...
std::optional<SDL_Texture*> GG::AssetManager::getTexture(std::string fileName) const
{
	if (!texturePtrs->contains(fileName)) return std::nullopt;
	return texturePtrs->at(fileName);
}
void GG::AssetManager::unloadTexture(std::string fileName)
{
...
std::weak_ptr<std::unordered_map<std::string, SDL_Texture*>> GG::AssetManager::getTexturePtrs() const
{
	return texturePtrs;
}


bool GG::AssetManager::loadTextFile(std::string fileName)
{
...
std::optional<GG::TextFile*> GG::AssetManager::getTextFile(std::string fileName) const
{
	if (!textFilePtrs->contains(fileName)) return std::nullopt;
	return textFilePtrs->at(fileName);
}
void GG::AssetManager::unloadTextFile(std::string fileName)
{
...
std::weak_ptr<std::unordered_map<std::string, GG::TextFile*>> GG::AssetManager::getTextFilePtrs() const
{
	return textFilePtrs;
}


std::string GG::AssetManager::getFilePath(std::string fileName) const
{
	return baseAssetPath + fileName;
}

template <typename T> void GG::AssetManager::freeMap(std::shared_ptr<std::unordered_map<std::string, T>> ptrMap, std::function<void(std::string)> freeFunc)
{
