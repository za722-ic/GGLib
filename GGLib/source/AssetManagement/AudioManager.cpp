...
MIX_Mixer* GG::AudioManager::getMixer() const
{
	return mixer;
}

void GG::AudioManager::setAudioPtrs(std::weak_ptr<std::unordered_map<std::string, MIX_Audio*>> newAudioPtrs)
{
	audioPtrs = newAudioPtrs;
}

void GG::AudioManager::playAudio(std::string fileName)
{
...
void GG::AudioManager::setVolume(float percentage)
{
	/*
